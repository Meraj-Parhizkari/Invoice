...
namespace InvoiceSystem.DataLayer.MSSQL.Migrations
{
    ...
    [Migration("20210309152645_add_baseTables_and_navigations")]
    partial class add_baseTables_and_navigations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.App.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.App.MyTestModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.CountryDivision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("ProductDiscunt")
                        .HasColumnType("decimal(18, 6)");
                    ...
                    b.ToTable("ProducOrderDetailts");
                });

            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ProdactCategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.App.Menu", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.App.Menu", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.CountryDivision", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.Invoice.CountryDivision", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.OrderDetail", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.Invoice.Order", "Order")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.Product", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.Invoice.ProductCategory", "ProductCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Invoice.ProductCategory", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.Invoice.ProductCategory", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
