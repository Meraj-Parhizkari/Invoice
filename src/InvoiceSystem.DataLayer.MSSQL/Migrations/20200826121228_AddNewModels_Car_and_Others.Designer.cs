...
namespace InvoiceSystem.DataLayer.MSSQL.Migrations
{
    ...
    [Migration("20200826121228_AddNewModels_Car_and_Others")]
    partial class AddNewModels_Car_and_Others
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Cars.CarF", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Cars.Car", b =>
                {
                    ...
                    b.HasOne("InvoiceSystem.Entities.Cars.CarF", "CarBrand")
                        .WithMany("CarCarBrands")
                        .HasForeignKey("CarBrandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InvoiceSystem.Entities.Cars.CarF", "CarModel")
                        .WithMany("CarCarModels")
                        .HasForeignKey("CarModelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InvoiceSystem.Entities.Cars.CarF", "CarType")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Cars.CarF", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.Cars.CarF", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
