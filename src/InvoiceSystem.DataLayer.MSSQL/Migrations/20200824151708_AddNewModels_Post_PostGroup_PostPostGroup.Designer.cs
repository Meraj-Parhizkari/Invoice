...
namespace InvoiceSystem.DataLayer.MSSQL.Migrations
{
    ...
    [Migration("20200824151708_AddNewModels_Post_PostGroup_PostPostGroup")]
    partial class AddNewModels_Post_PostGroup_PostPostGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Car.CarF", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InvoiceSystem.Entities.Car.CarF", b =>
                {
                    b.HasOne("InvoiceSystem.Entities.Car.CarF", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
